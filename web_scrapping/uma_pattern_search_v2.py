...
OUTPUT_FILE = '/sdcard/Download/uma_pattern_data_v2.json'
CURRENT_YEAR = "2025" 
...
def run_scraper():
    log("=== UMA PATTERN SEARCH V2: Iteración con Ciclo -1 ===")
    session = get_session()
        ...
        try:
            ...
            for grado in grados:
                ...
                for curso_num in range(1, 7):
                    # CAMBIO V2: El parámetro INICIO_LOV_CICLOS pasa de 1 a -1
