    ...
    fieldsets = (
        ...
        (
            "Configuración de Privacidad del Portafolio",
            {
                "classes": ("collapse",),
                "fields": (
                    "mostrar_phone_en_portafolio",
                    "mostrar_degree_en_portafolio",
                    "mostrar_current_year_en_portafolio",
                    "mostrar_university_en_portafolio",
                    "mostrar_hobbies_en_portafolio",
                    "mostrar_work_experience_en_portafolio",
                    "show_personal_description_in_portfolio",
                    "mostrar_professional_title_en_portafolio",
