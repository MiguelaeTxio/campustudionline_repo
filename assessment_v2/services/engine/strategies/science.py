...
class ScienceStrategy(BaseExamStrategy):
    ...
    def get_system_prompt(self) -> str:
        ...
        return (
            ...
            f'3. Para ILC-CONTEXT (W-CLIN-SCAN): incluye URL de imagen/gráfico en media_assets y keywords esperados.\n'
    ...
    def get_user_prompt(
        ...
        return (
            ...
            f'5. Para ILC-CONTEXT: media_assets con URL de imagen y keywords científicos esperados.\n'
